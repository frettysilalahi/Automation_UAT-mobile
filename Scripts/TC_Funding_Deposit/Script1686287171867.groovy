...
Mobile.tap(findTestObject('Object Funding/Deposit/android.view.ViewGroup  Funding Deposit'), 0)

Mobile.tap(findTestObject('Object Funding/Deposit/android.view.ViewGroup 1st Prod'), 0)

Mobile.tap(findTestObject('Object Funding/Deposit/android.widget.ImageView Copy to clipboard'), 0)
