...
Mobile.tap(findTestObject('Object_Unstaking/android.view.ViewGroup Staking Prod'), 0)

Mobile.tap(findTestObject('Object_Unstaking/android.widget.TextView - Unstake'), 0)

Mobile.tap(findTestObject('Object_Unstaking/android.widget.TextView - 25'), 0)

Mobile.checkElement(findTestObject('Object_Unstaking/android.widget.TextView - Confirm unstake'), 0)

Mobile.checkElement(findTestObject('Object_Unstaking/android.widget.TextView - Unstake Staking info'), 0)
